...
const Clock =()=>{
    ...
    return(
        ...
        <div className="flex justify-center items-center h-[100vh] bg-blue-950 " >
            ...
            <div className="h-[17%] w-[0.5%] left-[49.9%] top-[33%] absolute reshour-class" id="hour" style={{ transform: `rotate(${rotation.hour}deg)` }}></div>
            <div className="h-[25%] w-[0.5%] left-[49.9%] top-[25%] absolute resminute-class" id="minute"style={{ transform: `rotate(${rotation.minute}deg)` }}></div>
            <div className="h-[30%] w-[0.5%] left-[49.9%] top-[20%] absolute ressecond-class"  id="second"style={{ transform: `rotate(${rotation.second}deg)` }}></div>
            </div>
        </div>
        </>
    )
